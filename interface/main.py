...
# # python tools/vis/seg_video.py --video-path=E:/Acads/FYP/video_1.avi --save-path=E:/Acads/FYP/video_1_op.avi --config=configs/semantic_segmentation/erfnet/cityscapes_512x1024.py --checkpoint=erfnet_cityscapes_512x1024_20200918.pt

# # tools.vis.seg_video(video-path=PAD_test_images/seg_test_images/stuttgart_00.avi --save-path=PAD_test_images/seg_test_images/stuttgart_pred.avi --config=configs/semantic_segmentation/erfnet/cityscapes_512x1024.py --checkpoint=erfnet_cityscapes_512x1024_20200918.pt)
...
ap.add_argument("-m", "--model", default="E:\Acads\FYP\Code\pytorch-auto-drive\enet-model.net",
	help="path to deep learning segmentation model")
ap.add_argument("-c", "--classes", default="E:\Acads\FYP\Code\pytorch-auto-drive\enet-classes.txt",
	help="path to .txt file containing class labels")
ap.add_argument("-v", "--video", default="E:\Acads\FYP\Videos/video_6_Trim.mp4",
	help="path to input video file")
ap.add_argument("-o", "--output", default="E:\Acads\FYP\Videos/video_6_Trim_segmented.avi",
	help="path to output video file")
ap.add_argument("-s", "--show", type=int, default=0,
	help="whether or not to display frame to screen")
ap.add_argument("-l", "--colors", type=str, default="E:\Acads\FYP\Code\pytorch-auto-drive\enet-colors.txt",
